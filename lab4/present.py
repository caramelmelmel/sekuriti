...
# Adapted the codes from: https://github.com/xSAVIKx/PRESENT-cipher/blob/master/present/pyPresent.py
...
# this layer deals with the encryption
...
# forgot to go the other way round
